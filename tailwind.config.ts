  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "bounce-in": { "0%": { transform: "scale(0)" }, "50%": { transform: "scale(1.1)" }, "100%": { transform: "scale(1)" } },
        "fire-flicker": { "0%, 100%": { transform: "scale(1) rotate(0deg)" }, "25%": { transform: "scale(1.1) rotate(-3deg)" }, "75%": { transform: "scale(0.95) rotate(3deg)" } },
      },
      animation: {
